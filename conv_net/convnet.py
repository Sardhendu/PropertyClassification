...
def conv_net(img_shape, device_type):
    ...
    with tf.device(device_type):
        ...
        X = ops.conv_layer(inpX, k_shape=[5, 5, 3, filters[0]], stride=1, padding='SAME', w_init='tn', w_decay=None, scope_name='conv_1', add_smry=False)
        ...
        ## LAYER 2
        X = ops.conv_layer(X, k_shape=[5, 5, filters[0], filters[1]], stride=1, padding='SAME', w_init='tn', w_decay=None, scope_name='conv_2', add_smry=False)
