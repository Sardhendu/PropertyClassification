...
def conv_autoencoder(img_shape, device_type=None):
    ...
    enc_filter = [3 ,16 ,32 ,64, 128, 256, 256]  # 3 Represents the number of channels
    ...
    return dict(inpX=inpX, encoded=encoded, decoded=decoded, sigmoid_logits=sigmoid_logits,
