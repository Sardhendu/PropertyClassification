...
#
# create_batches_only_test = PythonOperator(dag=dag,
#                                           task_id='create_aerial_cropped_batches_new_test',
#                                           provide_context=True,
...
#
#
# test_new_data = PythonOperator(dag=dag,
...
#                               )
#
# predictions_on_test_new_data = PythonOperator(dag=dag,
...
#
#
# fetch_aerial >> fetch_aerial_cropped >> create_batches_only_test >> test_new_data >> predictions_on_test_new_data >> remove_batches
